...
import { BarChart3, Users, Cpu, Clock, TrendingUp, Activity } from "lucide-react";
    ...
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.models_available}</div>
            <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">GPT-4 • 2 minutes ago</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">API call successful</p>
                  <p className="text-xs text-muted-foreground">Claude-3 • 8 minutes ago</p>
                </div>
              </div>
            </div>
          </CardContent>
