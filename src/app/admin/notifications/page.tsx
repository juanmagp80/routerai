                        ...
                        <div className="divide-y divide-slate-200">
                            {filteredNotifications.map((notification, index) => (
                                <motion.div
                                    ...
                                    className={`p-6 cursor-pointer transition-all duration-200 hover:bg-slate-50 border-l-4 ${!notification.read ? getNotificationColor(notification.type) : 'border-l-slate-200 bg-white'
